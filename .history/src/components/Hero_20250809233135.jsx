...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex flex-col justify-center items-center text-center px-6 w-full max-w-6xl mx-auto">
      <div className="pointer-events-none absolute inset-0 -z-10 opacity-80 dark:opacity-60">
