...
export default function Contact() {
  return (
    <section id="contact" className="py-20 px-6 text-center w-full max-w-3xl mx-auto">
      ...
      <p className="mt-6 text-sm text-slate-500">Hoặc liên hệ trực tiếp: <a className="text-sky-700 hover:underline dark:text-violet-300" href={`mailto:${profile.email}`}>{profile.email}</a></p>
    </section>
  );
}
